module GOVUKDesignSystemFormBuilder
  module Builder
    ...
    # @param presenter [#message_for] any object that responds to `#message_for`. If supplied
    #   then summary error message wording will be generated by sending `message_for` to this
    #   presenter object for each attribute that has errors on the builder object, passing
    #   the attribute and an array of <String>messages (`#message_for(attribute, messages)`.
