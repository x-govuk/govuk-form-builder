module GOVUKDesignSystemFormBuilder
  module Builder
    ...
    # @param presenter [Object] a presenter object that can respond to `summary_message_for`. If supplied
    #   then summary error messages will be generated by sending `summary_message_for` to this
    #   presenter object for each attribute that has errors on the builder object.
